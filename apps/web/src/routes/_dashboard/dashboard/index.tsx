      ...
      <section className="flex flex-col gap-6">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-base-content/70">
            Browse the Karura trail map, monitor upstream sync progress, and open the data explorer
            for local map tables.
          </p>
        </div>
        <div className="rounded-2xl border border-base-content/10 bg-base-100/70 p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Link to="/sync" className="btn btn-outline btn-sm">
              Open sync
            </Link>
